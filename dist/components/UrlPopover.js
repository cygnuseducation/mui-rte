...
var UrlPopover = function (props) {
    ...
    return (react_1.default.createElement(Popover_1.default, { open: props.anchor !== undefined, anchorEl: props.anchor, onClose: onSave, anchorOrigin: {
            vertical: "bottom",
            horizontal: "left"
        }, transformOrigin: {
            vertical: 'top',
            ...
            react_1.default.createElement(Grid_1.default, { container: true, spacing: 1 },
                react_1.default.createElement(Grid_1.default, { container: true, item: true, xs: 12 },
                    ...
                    props.isMedia ?
                        ...
                        : null),
                react_1.default.createElement(Grid_1.default, { container: true, className: classes.popoverButtons, item: true, xs: 12, direction: "row", justifyContent: "flex-end" },
                    props.data && props.data.url ?
                        react_1.default.createElement(Button_1.default, { className: classes.submitButton, onClick: function () { return props.onConfirm(props.isMedia, ""); } },
                            react_1.default.createElement(DeleteOutline_1.default, null))
                        : null,
                    react_1.default.createElement(Button_1.default, { className: classes.submitButton, onClick: onSave },
